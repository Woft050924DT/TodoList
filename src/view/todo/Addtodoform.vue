<template>
  <div class="bg-white rounded-xl border border-gray-200 p-4 mb-4 shadow-sm">
    <div class="flex items-center justify-between mb-3">
      <h3 class="font-semibold text-gray-700">Công việc mới</h3>
      <button
        @click="$emit('close')"
    ...
    <input
      ...
      class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-300 focus:border-violet-400 mb-2 transition"
    />
    <textarea
      v-model="form.description"
      placeholder="Mô tả (tùy chọn)..."
      rows="2"
      class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-300 focus:border-violet-400 mb-3 transition resize-none"
    ></textarea>
    ...
    <div class="flex items-center gap-2 flex-wrap mb-4">
      ...
      <div class="flex gap-1">
        <button
          ...
          class="flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-medium border transition-all"
          :class="
      ...
      <select
        ...
        class="border border-gray-200 rounded-lg px-2.5 py-1 text-xs text-gray-600 focus:outline-none focus:ring-2 focus:ring-violet-300 transition"
      >
    ...
    <div class="flex justify-end gap-2">
      ...
      <button
        @click="submit"
        class="px-5 py-2 bg-violet-600 hover:bg-violet-700 text-white text-sm font-semibold rounded-lg transition-colors shadow-sm shadow-violet-200 disabled:opacity-50"
